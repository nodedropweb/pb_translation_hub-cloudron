...
IMPORTANT:
1. Return ONLY the translated HTML — no introduction, no comments, no explanations, no labels (do NOT write "Summary:", "Body:", "Zusammenfassung:", "Hauptbeschreibung:", "Main Description:", "Here is the translation", etc.).
2. Output VALID HTML, never Markdown. Do NOT use #, ##, ###, **, *, - or backticks, and do NOT wrap the output in code fences. For sub-headings use <h3>–<h6> (never <h1>/<h2>).
3. Keep ALL existing HTML tags (<p>, <a>, <ul>, <li>, <strong>, <em>, <code>, <pre>, <img>, etc.) exactly as they are in the source. Translate only the visible text content inside the tags.
